...
import Img4 from '../assets/img/carousel-1.jpg';
...
function Service() {
  return (
   ...
   {/* Page Header Start */}
<div className="container-fluid page-header mb-5 p-0" style={{backgroundImage: `url(${Img4})`}}>
      ...
      <div className="owl-carousel testimonial-carousel py-5">
        <div className="testimonial-item position-relative bg-white rounded overflow-hidden">
          ...
          <div className="d-flex align-items-center">
            <img className="img-fluid flex-shrink-0 rounded" src={Img1} style={{width: 45, height: 45}} />
            <div className="ps-3">
